"""
Script pour créer et déployer l'actor ExP France sur Apify via l'API REST
"""
import requests
import os
...
ACTOR_NAME = "exp-france-scraper"
ACTOR_TITLE = "ExP France Scraper"
ACTOR_DESCRIPTION = "Scrape tous les agents ExP France et push dans Supabase staging"
...
def main():
    print("=" * 50)
    print("Deploiement ExP France Scraper sur Apify")
    print("=" * 50)
