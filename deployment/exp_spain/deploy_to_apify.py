"""
Script pour créer et déployer l'actor ExP Spain sur Apify via l'API REST
"""
import requests
import os
...
ACTOR_NAME = "exp-spain-scraper"
ACTOR_TITLE = "ExP Spain Scraper"
ACTOR_DESCRIPTION = "Scrape tous les agents ExP Spain et push dans Supabase staging"
...
def main():
    print("=" * 50)
    print("Deploiement ExP Spain Scraper sur Apify")
    print("=" * 50)
