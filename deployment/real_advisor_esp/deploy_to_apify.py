"""
Script pour créer et déployer l'actor RealAdvisor Spain sur Apify via l'API REST
"""
import requests
import os
...
ACTOR_NAME = "realadvisor-spain-scraper"
ACTOR_TITLE = "RealAdvisor Spain Scraper"
ACTOR_DESCRIPTION = "Scrape les agents RealAdvisor Spain et push dans Supabase staging"
...
def main():
    print("=" * 50)
    print("Deploiement RealAdvisor Spain Scraper sur Apify")
    print("=" * 50)
