"""
Script pour créer et déployer l'actor iad Spain sur Apify via l'API REST
"""
import requests
import os
...
ACTOR_NAME = "iad-spain-scraper"
ACTOR_TITLE = "iad Spain Scraper"
ACTOR_DESCRIPTION = "Scrape tous les conseillers iad Spain et push dans Supabase staging"
...
def main():
    print("=" * 50)
    print("Deploiement iad Spain Scraper sur Apify")
    print("=" * 50)
